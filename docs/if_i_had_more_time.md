...
2. Investigate more optimal parsing techniques for NEM12 and better ways to handle NEM12 data in general.
...
6. Conduct a more thorough code review of the `main.go` structure. The initial focus was on ensuring correct output, and I used Sonnet to generate the code due to time constraints.